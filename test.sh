...
# set -a
# source "${this_script_test_sh_folder_path}/command/docker/.env.platforms_supported_by_alpine"
...
# source "${this_script_test_sh_folder_path}/command/docker/platforms.sh"
